        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          <div className="lg:col-span-4 space-y-6">
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                <span className="inline-flex items-center gap-1 text-xs font-semibold text-indigo-700 bg-indigo-50 px-2.5 py-0.5 rounded-full border border-indigo-100">
                  <Building2 className="w-3.5 h-3.5" />
                  {product.companyName || 'Verified Merchant Store'}
                </span>
          ...
          <div className="lg:col-span-3 sticky top-20 space-y-4">
            <div className="bg-white border border-zinc-200 rounded-3xl p-6 shadow-sm space-y-5">
              ...
              {/* Merchant Details */}
              <div className="pt-3 border-t border-zinc-200/80 space-y-1 text-[11px] text-zinc-500">
                ...
                <div className="flex justify-between">
                  <span>Sold by</span>
                  <span className="text-indigo-600 font-medium">{product.companyName || 'Verified Merchant'}</span>
                </div>
                <div className="flex justify-between">
              ...
              {relatedProducts.map((rel) => (
                ...
                >
                  ...
                  <div className="pt-3 flex items-center justify-between border-t border-zinc-100 mt-3">
                    ...
                    <span className="text-[11px] font-semibold text-zinc-600 hover:text-zinc-950">
                      View Details →
                    </span>
                  </div>
                </div>
